  ...
  return (
    <>
      {!user ? (
        ...
        <header className="fixed top-0 flex items-center justify-between w-screen xl:px-16 px-0 pr-3 py-0 sm:bg-gradient-to-b sm:from-neutral-900 sm:from-10% bg-neutral-900 z-10">
          <div className="flex">
            <NavLink to="/browse">
              <img
